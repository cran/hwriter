appendExample=function(argument,description,example,df=NULL,name=NULL) {
  p=file()
  ...
  ## names description
  if (!is.null(name)) description=hwrite(description, name=name)
...
showExample=function() {
  ...
  text=c(text,hwrite(paste(hwrite('hwriter',style='font-family:monospace'),'is an easy-to-use package able to format and output R (from the R-project) objects in HTML format. It supports advanced formatting, tables, CSS styling, images, Javascript and provides a convenient mapping between R tables and HTML tables.'),br=TRUE))
  ...
  text=c(text,hwrite(paste('This page (generated by ',hwrite('hwriter',style='font-family:monospace'),') shows examples of the package abilities and illustrates in detail the behavior of the optional arguments used by the function ',hwrite('hwrite()',style='font-family:monospace'),'. All the examples on this page are using the ',hwrite('current',link='hwriter.css'),' CSS stylesheet.',sep='')))
  hwrite(paste(text,collapse='\n'),p,class='intro',div=TRUE)
 ...
 df=appendExample(NULL,paste('Named anchors and customized CSS hyperlinks using classes in the ',hwrite('current',link="hwriter.css"),' CSS stylesheet and margins.',sep=''),"
  ...
  df=appendExample(NULL,"Use of Javascript through \'onmouseover\' and \'onmouseout\' attributes.","
   ...
   df=appendExample(NULL,'Build HTML tags using \'hmakeTag\' to render additonal HTML objects.',"
     ...
     hwrite(hmakeTag('ul', li), p, style='font-weight:bold; text-align:left') 
     ## closePage(p)",df)
