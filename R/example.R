...
showExample=function() {
  ...
  text=c(text,hwrite(paste('This page (generated by ',hwrite('hwriter',style='font-family:monospace'),') illustrates the behavior of optional arguments understood by ',hwrite('hwrite()',style='font-family:monospace'),
               ' and shows some general examples of what can be done using the ',hwrite('hwriter',style='font-family:monospace'),' package. ',sep='')))
  ...
  hwrite(paste('1. Arguments used by',hwrite('hwrite()',style='font-family:monospace')),p,heading=1)
  hwrite('1.1. General arguments',p,heading=2)
  ...
  ## Text elements
  hwrite('1.2. Text elements specific arguments',p,heading=2)
...
",
  ...
  ## Vector
  hwrite('1.3. Vector specific arguments',p,heading=2)
...
hwrite(z, p, names=FALSE)",df)
  ...
  ## Table
  hwrite('1.4. Table specific arguments',p,heading=2)
...
hwrite(iris[1:2,1:2], p, center=TRUE, br=TRUE, row.bgcolor='#ffaaaa', cellpadding=10)",df)
  ...
  ## Examples
  hwrite('2. General examples',p,heading=1)
  hwrite(paste('The following examples illustrate the capabilities of the ',
               hwrite('hwriter',style='font-family:monospace'),' package using the functions ',
               hwrite('hwrite()',style='font-family:monospace'),' and ',
               hwrite('hwriteImage()',style='font-family:monospace'),'.',sep=''),
         p,br=T)
  hwrite('',p,br=T)
